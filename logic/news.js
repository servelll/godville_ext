...
/*function AddCouponListeners() {
	//console.log("AddCouponListeners start");
	...
	console.log("AddCouponListeners done");
}
*/


//TODO кнопка повешения попыток кликнуть на кнопку по таймауту
//TODO закрыть вкладку-чекбокс
